...
<div class="content">
    <ul class="video_ul">
        <?php if(is_array($videos)): $i = 0; $__LIST__ = $videos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="video_li">
                <a class="video_link" target="_blank" href="<?php echo U('Index/play?link='.base64_encode($vo['videosrc']));?>">
                    <img class="video_img" src="/Public/Image/Iqiyi/<?php echo ($vo["src"]); ?>" />
